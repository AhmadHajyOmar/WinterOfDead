...
public class ModelBuilderImpl implements ModelBuilder<Model> {
    ...
    public final CrossroadsFactory<Crossroads> crossroadsFactory;
    ...
    private final List<Crossroads> crossroads;
    ...
    public ModelBuilderImpl(
            final CardFactory<Card> cardFactory, final AbilityFactory<Ability> abilityFactory,
            final CrossroadsFactory<Crossroads> crossroadsFactory) {
        ...
        this.crossroadsFactory = crossroadsFactory;
    }
    ...
    public void addCrossroads(final int id, final String name, final ParamMap paramMap,
        ...
        final Crossroads crossroad = crossroadsFactory.createCrossroads(id, name, paramMap,
                crossroadName, crossroadParams);
