...
import de.unisaarland.cs.se.sopra.crossroads.ConsequenceFactoryImpl;
import de.unisaarland.cs.se.sopra.crossroads.Crossroads;
import de.unisaarland.cs.se.sopra.crossroads.CrossroadsFactoryImpl;
        ...
        try {
            ...
            try (final ConnectionWrapper connection = new ConnectionWrapper(serverConnection)) {
                ...
                final CrossroadsFactory<Crossroads> crossroadsFactory =
                        new CrossroadsFactoryImpl(consequenceFactory);
                final ModelBuilder<Model> modelBuilder =
                        new Validator<>(new ModelBuilderImpl(cardFactory, abilityFactory,
                            crossroadsFactory));
