...
public class NoSearchedIfRandomEncounter extends SystemTest {

    public NoSearchedIfRandomEncounter() {
        super(NoSearchedIfRandomEncounter.class, false);
    }
