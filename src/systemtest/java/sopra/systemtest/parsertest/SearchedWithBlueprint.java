...
public class SearchedWithBlueprint extends SystemTest {

    public SearchedWithBlueprint() {
        super(SearchedWithBlueprint.class, false);
    }
    ...
    protected void run() throws TimeoutException, AssertionError {
        ...
        this.assertCharacters(1, 1, 5, 2, 3);
        ...
        // player phase
        this.assertActNow(1);
        this.sendUseCard(1, 1000, 2, 2);
        this.assertCardUsed(1, 1000, 2, 2);
        this.assertActNow(1);
        this.sendMove(1, 2, 4);
        this.assertMoved(1, 2, 4);
        this.assertFrostbitten(1, 2);
        this.assertActNow(1);
        this.sendSearch(1, 2);
        this.assertSearched(1, 2, 4);
