...
public class TriggerLockCard extends SystemTest {

    public TriggerLockCard() {
        super(TriggerLockCard.class, false);
    }
    ...
    protected void run() throws TimeoutException, AssertionError {
        ...
        // player phase
        this.assertActNow(1);
        this.sendUseCard(1, 1000, 3, 0);
        this.assertCardUsed(1, 1000, 3, 0);
