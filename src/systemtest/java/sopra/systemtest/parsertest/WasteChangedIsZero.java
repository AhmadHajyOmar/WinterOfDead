...
public class WasteChangedIsZero extends SystemTest {

    public WasteChangedIsZero() {
        super(WasteChangedIsZero.class, false);
    }
    ...
    protected void run() throws TimeoutException, AssertionError {
        ...
        this.assertActNow(1);
        this.sendCleanWaste(1, 2);
        this.assertWasteChanged(1, -4);
