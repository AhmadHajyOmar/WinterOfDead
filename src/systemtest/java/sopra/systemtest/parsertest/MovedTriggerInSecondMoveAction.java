...
public class MovedTriggerInSecondMoveAction extends SystemTest {

    public MovedTriggerInSecondMoveAction() {
        super(MovedTriggerInSecondMoveAction.class, false);
    }
