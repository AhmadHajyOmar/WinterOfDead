...
public class SearchedUsingBlueprintButLost extends SystemTest {

    public SearchedUsingBlueprintButLost() {
        super(SearchedUsingBlueprintButLost.class, false);
    }
    ...
    protected void run() throws TimeoutException, AssertionError {
        ...
        // player phase
        this.assertActNow(1);
        this.sendUseCard(1, 1003, 2, 2);
        this.assertCardUsed(1, 1003, 2, 2);
        this.assertActNow(1);
        this.sendMove(1, 2, 4);
